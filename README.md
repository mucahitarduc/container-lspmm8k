...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lspmm8k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lspmm8k.containers.anotherwebservice.com/
...
```
git clone git@github.com:mucahitarduc/container-lspmm8k.git
cd container-lspmm8k
```
...
```
docker attach container-lspmm8k
```
